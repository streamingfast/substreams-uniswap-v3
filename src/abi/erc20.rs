...
pub mod events {
    ...
    impl Approval {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            let mut values = ethabi::decode(&[ethabi::ParamType::Uint(256usize)], log.data.as_ref())
            ...
            Ok(Self {
                ...
                spender: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'spender' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
