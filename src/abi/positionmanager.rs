...
pub mod functions {
    ...
    impl DomainSeparator {
        ...
        pub fn output_call(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<[u8; 32usize], String> {
            Self::output(call.return_data.as_ref())
        }
        pub fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            let mut values = ethabi::decode(&[ethabi::ParamType::FixedBytes(32usize)], data.as_ref())
    ...
    impl BalanceOf {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Address(ethabi::Address::from_slice(&self.owner))]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
    ...
    impl BaseUri {
        ...
        pub fn output_call(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<String, String> {
            Self::output(call.return_data.as_ref())
        }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<Vec<u8>> for CreateAndInitializePoolIfNecessary {
        fn output(data: &[u8]) -> Result<Vec<u8>, String> {
            Self::output(data)
        }
    }
    ...
    impl Multicall {
        ...
        pub fn output_call(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Vec<Vec<u8>>, String> {
            Self::output(call.return_data.as_ref())
        }
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                operator: values
                    ...
                    .as_bytes()
                    .to_vec(),
                approved: values.pop().expect(INTERNAL_ERR).into_bool().expect(INTERNAL_ERR),
            })
        }
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
    ...
    impl SupportsInterface {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::FixedBytes(4usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                interface_id: {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::FixedBytes(self.interface_id.as_ref().to_vec())]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
...
pub mod events {
    ...
    impl Approval {
        const TOPIC_ID: [u8; 32] = [
            140u8, 91u8, 225u8, 229u8, 235u8, 236u8, 125u8, 91u8, 209u8, 79u8, 113u8, 66u8, 125u8, 30u8, 132u8, 243u8,
            221u8, 3u8, 20u8, 192u8, 247u8, 178u8, 41u8, 30u8, 91u8, 32u8, 10u8, 200u8, 199u8, 195u8, 185u8, 37u8,
        ];
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    ...
                    .as_bytes()
                    .to_vec(),
                approved: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!(
                ...
                token_id: {
                    let mut v = [0 as u8; 32];
                    ethabi::decode(&[ethabi::ParamType::Uint(256usize)], log.topics[3usize].as_ref())
                        .map_err(|e| {
                            format!(
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    ...
                    .as_bytes()
                    .to_vec(),
                operator: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl Collect {
        const TOPIC_ID: [u8; 32] = [
            64u8, 208u8, 239u8, 209u8, 165u8, 61u8, 96u8, 236u8, 191u8, 64u8, 151u8, 27u8, 157u8, 175u8, 125u8, 201u8,
            1u8, 120u8, 195u8, 170u8, 220u8, 122u8, 171u8, 23u8, 101u8, 99u8, 39u8, 56u8, 250u8, 139u8, 143u8, 1u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                token_id: {
                    let mut v = [0 as u8; 32];
                    ethabi::decode(&[ethabi::ParamType::Uint(256usize)], log.topics[1usize].as_ref())
                        .map_err(|e| {
                            format!(
                                "unable to decode param 'token_id' from topic of type 'uint256': {:?}",
                                e
    ...
    impl DecreaseLiquidity {
        const TOPIC_ID: [u8; 32] = [
            38u8, 246u8, 160u8, 72u8, 238u8, 145u8, 56u8, 242u8, 192u8, 206u8, 38u8, 111u8, 50u8, 44u8, 185u8, 146u8,
            40u8, 232u8, 214u8, 25u8, 174u8, 43u8, 255u8, 48u8, 198u8, 127u8, 141u8, 207u8, 157u8, 35u8, 119u8, 180u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl IncreaseLiquidity {
        const TOPIC_ID: [u8; 32] = [
            48u8, 103u8, 4u8, 139u8, 238u8, 227u8, 27u8, 37u8, 178u8, 241u8, 104u8, 31u8, 136u8, 218u8, 200u8, 56u8,
            200u8, 187u8, 163u8, 106u8, 242u8, 91u8, 251u8, 43u8, 124u8, 247u8, 71u8, 58u8, 88u8, 71u8, 227u8, 95u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl Transfer {
        const TOPIC_ID: [u8; 32] = [
            ...
            170u8, 149u8, 43u8, 167u8, 241u8, 99u8, 196u8, 161u8, 22u8, 40u8, 245u8, 90u8, 77u8, 245u8, 35u8, 179u8,
            239u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                from: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'from' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                ...
                to: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'to' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
