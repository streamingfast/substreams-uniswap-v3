...
pub mod functions {
    ...
    pub struct Collect {
        ...
        pub amount0_max: ethabi::Uint,
        pub amount1_max: ethabi::Uint,
    }
    impl Collect {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Uint(self.amount0_max),
                ethabi::Token::Uint(self.amount1_max),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl CreateAndInitializePoolIfNecessary {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Uint(self.sqrt_price_x96),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    pub struct DecreaseLiquidity {
        ...
        pub amount0_min: ethabi::Uint,
        pub amount1_min: ethabi::Uint,
    ...
    impl DecreaseLiquidity {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Uint(self.token_id),
                ethabi::Token::Uint(self.liquidity),
                ethabi::Token::Uint(self.amount0_min),
                ethabi::Token::Uint(self.amount1_min),
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint)> for DecreaseLiquidity {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    ...
    pub struct IncreaseLiquidity {
        pub token_id: ethabi::Uint,
        pub amount0_desired: ethabi::Uint,
        pub amount1_desired: ethabi::Uint,
        pub amount0_min: ethabi::Uint,
        pub amount1_min: ethabi::Uint,
        pub deadline: ethabi::Uint,
    }
    impl IncreaseLiquidity {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                token_id: values
                    ...
                    .into_uint()
                    .expect(INTERNAL_ERR),
                amount0_desired: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
                amount1_desired: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Uint(self.token_id),
                ethabi::Token::Uint(self.amount0_desired),
                ethabi::Token::Uint(self.amount1_desired),
                ethabi::Token::Uint(self.amount0_min),
                ethabi::Token::Uint(self.amount1_min),
                ethabi::Token::Uint(self.deadline),
            ]);
        ...
        pub fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint, ethabi::Uint), String> {
            let mut values = ethabi::decode(
                &[
                    ethabi::ParamType::Uint(128usize),
                    ethabi::ParamType::Uint(256usize),
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<(ethabi::Uint, ethabi::Uint, ethabi::Uint)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall {
                    to_addr: address,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint, ethabi::Uint)>
        for IncreaseLiquidity
    {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    ...
    pub struct SweepToken {
        pub token: Vec<u8>,
        pub amount_minimum: ethabi::Uint,
        pub recipient: Vec<u8>,
    }
    impl SweepToken {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.token)),
                ethabi::Token::Uint(self.amount_minimum),
                ethabi::Token::Address(ethabi::Address::from_slice(&self.recipient)),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for TokenOfOwnerByIndex {
        fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
            Self::output(data)
        }
    }
    ...
    pub struct UniswapV3MintCallback {
        pub amount0_owed: ethabi::Uint,
        pub amount1_owed: ethabi::Uint,
        pub data: Vec<u8>,
    }
    impl UniswapV3MintCallback {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Uint(self.amount0_owed),
                ethabi::Token::Uint(self.amount1_owed),
                ethabi::Token::Bytes(self.data.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
...
pub mod events {
    ...
    impl Collect {
        const TOPIC_ID: [u8; 32] = [
            64u8, 208u8, 239u8, 209u8, 165u8, 61u8, 96u8, 236u8, 191u8, 64u8, 151u8, 27u8, 157u8,
            175u8, 125u8, 201u8, 1u8, 120u8, 195u8, 170u8, 220u8, 122u8, 171u8, 23u8, 101u8, 99u8,
            39u8, 56u8, 250u8, 139u8, 143u8, 1u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl DecreaseLiquidity {
        const TOPIC_ID: [u8; 32] = [
            38u8, 246u8, 160u8, 72u8, 238u8, 145u8, 56u8, 242u8, 192u8, 206u8, 38u8, 111u8, 50u8,
            44u8, 185u8, 146u8, 40u8, 232u8, 214u8, 25u8, 174u8, 43u8, 255u8, 48u8, 198u8, 127u8,
            141u8, 207u8, 157u8, 35u8, 119u8, 180u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
    ...
    impl IncreaseLiquidity {
        const TOPIC_ID: [u8; 32] = [
            48u8, 103u8, 4u8, 139u8, 238u8, 227u8, 27u8, 37u8, 178u8, 241u8, 104u8, 31u8, 136u8,
            218u8, 200u8, 56u8, 200u8, 187u8, 163u8, 106u8, 242u8, 91u8, 251u8, 43u8, 124u8, 247u8,
            71u8, 58u8, 88u8, 71u8, 227u8, 95u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 2usize {
                return false;
