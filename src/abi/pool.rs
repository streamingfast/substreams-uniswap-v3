...
pub mod functions {
    ...
    pub struct Burn {
        pub tick_lower: EthBigInt,
        pub tick_upper: EthBigInt,
    ...
    impl Burn {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                {
                    let non_full_signed_bytes = self.tick_lower.get_big_int().to_signed_bytes_be();
                ...
                {
                    let non_full_signed_bytes = self.tick_upper.get_big_int().to_signed_bytes_be();
                    let mut full_signed_bytes = [0xff as u8; 32];
                    non_full_signed_bytes
                        .into_iter()
                        .rev()
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<(ethabi::Uint, ethabi::Uint)> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint)> for Burn {
    ...
    pub struct Collect {
        ...
        pub tick_lower: EthBigInt,
        pub tick_upper: EthBigInt,
        pub amount0_requested: ethabi::Uint,
        pub amount1_requested: ethabi::Uint,
    }
    impl Collect {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                ...
                amount0_requested: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
                amount1_requested: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ...
                ethabi::Token::Uint(self.amount0_requested),
                ethabi::Token::Uint(self.amount1_requested),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint)> for Collect {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint)> for CollectProtocol {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for FeeGrowthGlobal0X128 {
        fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for FeeGrowthGlobal1X128 {
        fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
            Self::output(data)
        }
    }
    ...
    impl Flash {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.recipient)),
                ethabi::Token::Uint(self.amount0),
                ethabi::Token::Uint(self.amount1),
    ...
    pub struct IncreaseObservationCardinalityNext {
        pub observation_cardinality_next: ethabi::Uint,
    }
    impl IncreaseObservationCardinalityNext {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            values.reverse();
            Ok(Self {
                observation_cardinality_next: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Uint(self.observation_cardinality_next)]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
    ...
    impl Initialize {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Uint(self.sqrt_price_x96)]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
            encoded
    ...
    impl substreams_ethereum::rpc::RPCDecodable<ethabi::Uint> for MaxLiquidityPerTick {
        fn output(data: &[u8]) -> Result<ethabi::Uint, String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint)> for Mint {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    ...
    impl Observations {
        ...
        pub fn call(
            &self,
            address: Vec<u8>,
        ) -> Option<(ethabi::Uint, EthBigInt, ethabi::Uint, bool)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall {
                    to_addr: address,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, EthBigInt, ethabi::Uint, bool)>
        for Observations
    {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, EthBigInt, ethabi::Uint, bool), String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct Observe {
        pub seconds_agos: Vec<ethabi::Uint>,
    }
    impl Observe {
        ...
        pub fn output(data: &[u8]) -> Result<(Vec<EthBigInt>, Vec<ethabi::Uint>), String> {
            let mut values = ethabi::decode(
                &[
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<(Vec<EthBigInt>, Vec<ethabi::Uint>)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall {
                    to_addr: address,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(Vec<EthBigInt>, Vec<ethabi::Uint>)> for Observe {
        fn output(data: &[u8]) -> Result<(Vec<EthBigInt>, Vec<ethabi::Uint>), String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(ethabi::Uint, ethabi::Uint)> for ProtocolFees {
        fn output(data: &[u8]) -> Result<(ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    ...
    pub struct SetFeeProtocol {
        pub fee_protocol0: ethabi::Uint,
        pub fee_protocol1: ethabi::Uint,
    }
    impl SetFeeProtocol {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            values.reverse();
            Ok(Self {
                fee_protocol0: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
                fee_protocol1: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_uint()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Uint(self.fee_protocol0),
                ethabi::Token::Uint(self.fee_protocol1),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl SnapshotCumulativesInside {
        ...
        pub fn output(data: &[u8]) -> Result<(EthBigInt, ethabi::Uint, ethabi::Uint), String> {
            let mut values = ethabi::decode(
                &[
                    ethabi::ParamType::Int(56usize),
                    ethabi::ParamType::Uint(160usize),
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<(EthBigInt, ethabi::Uint, ethabi::Uint)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall {
                    to_addr: address,
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(EthBigInt, ethabi::Uint, ethabi::Uint)>
        for SnapshotCumulativesInside
    {
        fn output(data: &[u8]) -> Result<(EthBigInt, ethabi::Uint, ethabi::Uint), String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct Swap {
        ...
        pub amount_specified: EthBigInt,
        pub sqrt_price_limit_x96: ethabi::Uint,
        pub data: Vec<u8>,
    }
    impl Swap {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[
                ethabi::Token::Address(ethabi::Address::from_slice(&self.recipient)),
                ethabi::Token::Bool(self.zero_for_one),
                {
                    let non_full_signed_bytes =
                        self.amount_specified.get_big_int().to_signed_bytes_be();
                    let mut full_signed_bytes = [0xff as u8; 32];
                    non_full_signed_bytes
                        .into_iter()
                        .rev()
                ...
                ethabi::Token::Uint(self.sqrt_price_limit_x96),
                ethabi::Token::Bytes(self.data.clone()),
            ]);
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
        ...
        pub fn output_call(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<(EthBigInt, EthBigInt), String> {
            Self::output(call.return_data.as_ref())
        }
        pub fn output(data: &[u8]) -> Result<(EthBigInt, EthBigInt), String> {
            let mut values = ethabi::decode(
                &[
                    ethabi::ParamType::Int(256usize),
                    ethabi::ParamType::Int(256usize),
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<(EthBigInt, EthBigInt)> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall {
                    to_addr: address,
    ...
    impl TickBitmap {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[{
                let non_full_signed_bytes = self.word_position.get_big_int().to_signed_bytes_be();
                let mut full_signed_bytes = [0xff as u8; 32];
                non_full_signed_bytes
                    .into_iter()
                    .rev()
    ...
    impl TickSpacing {
        ...
        pub fn output_call(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<EthBigInt, String> {
            Self::output(call.return_data.as_ref())
        }
        pub fn output(data: &[u8]) -> Result<EthBigInt, String> {
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<EthBigInt> {
            use substreams_ethereum::pb::eth::rpc;
            let rpc_calls = rpc::RpcCalls {
                calls: vec![rpc::RpcCall {
                    to_addr: address,
    ...
    impl Ticks {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[{
                let non_full_signed_bytes = self.tick.get_big_int().to_signed_bytes_be();
                let mut full_signed_bytes = [0xff as u8; 32];
                non_full_signed_bytes
                    .into_iter()
                    .rev()
...
pub mod events {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    ...
                    .as_bytes()
                    .to_vec(),
                tick_lower: EthBigInt::new(substreams::scalar::BigInt::from_signed_bytes_be(
                    log.topics[2usize].as_ref(),
                )),
                tick_upper: EthBigInt::new(substreams::scalar::BigInt::from_signed_bytes_be(
    ...
    pub struct Swap {
        pub sender: Vec<u8>,
        pub recipient: Vec<u8>,
        pub amount0: EthBigInt,
        pub amount1: EthBigInt,
        pub sqrt_price_x96: ethabi::Uint,
