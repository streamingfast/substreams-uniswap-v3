...
pub mod functions {
    ...
    impl Burn {
        ...
        pub fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            let mut values = ethabi::decode(
        ...
        pub fn call(&self, address: Vec<u8>) -> Option<(substreams::scalar::BigInt, substreams::scalar::BigInt)> {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(substreams::scalar::BigInt, substreams::scalar::BigInt)> for Burn {
        fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(substreams::scalar::BigInt, substreams::scalar::BigInt)> for Collect {
        fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
        }
    }
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(substreams::scalar::BigInt, substreams::scalar::BigInt)>
        for CollectProtocol
    {
        fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
    ...
    impl Factory {
        ...
        pub fn output_call(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Vec<u8>, String> {
            Self::output(call.return_data.as_ref())
        }
    ...
    impl IncreaseObservationCardinalityNext {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::Uint(16usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
    ...
    impl Initialize {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::Uint(160usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                sqrt_price_x96: {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(substreams::scalar::BigInt, substreams::scalar::BigInt)> for Mint {
        fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
        }
    }
    ...
    impl Observations {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::Uint(256usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                index: {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                seconds_agos: values
                    ...
                    .map(|inner| {
                        let mut v = [0 as u8; 32];
                        inner.into_uint().expect(INTERNAL_ERR).to_big_endian(v.as_mut_slice());
                        substreams::scalar::BigInt::from_unsigned_bytes_be(&v)
                    })
                    .collect(),
            })
        ...
        pub fn output(
            ...
            Ok((
                values
                    ...
                    .map(|inner| {
                        let mut v = [0 as u8; 32];
                        inner.into_int().expect(INTERNAL_ERR).to_big_endian(v.as_mut_slice());
                        substreams::scalar::BigInt::from_signed_bytes_be(&v)
                    })
                    .collect(),
                values
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(Vec<substreams::scalar::BigInt>, Vec<substreams::scalar::BigInt>)>
        for Observe
    {
        fn output(data: &[u8]) -> Result<(Vec<substreams::scalar::BigInt>, Vec<substreams::scalar::BigInt>), String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    ...
    impl Positions {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::FixedBytes(32usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                key: {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(substreams::scalar::BigInt, substreams::scalar::BigInt)> for ProtocolFees {
        fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
        }
    }
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            Ok(Self {
                recipient: values
                    ...
                    .as_bytes()
                    .to_vec(),
                zero_for_one: values.pop().expect(INTERNAL_ERR).into_bool().expect(INTERNAL_ERR),
                amount_specified: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
    ...
    impl substreams_ethereum::rpc::RPCDecodable<(substreams::scalar::BigInt, substreams::scalar::BigInt)> for Swap {
        fn output(data: &[u8]) -> Result<(substreams::scalar::BigInt, substreams::scalar::BigInt), String> {
            Self::output(data)
        }
    }
    ...
    impl TickBitmap {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::Int(16usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                word_position: {
    ...
    impl Ticks {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::Int(24usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                tick: {
...
pub mod events {
    ...
    impl Burn {
        const TOPIC_ID: [u8; 32] = [
            12u8, 57u8, 108u8, 217u8, 137u8, 163u8, 159u8, 68u8, 89u8, 181u8, 250u8, 26u8, 237u8, 106u8, 154u8, 141u8,
            205u8, 188u8, 69u8, 144u8, 138u8, 207u8, 214u8, 126u8, 2u8, 140u8, 213u8, 104u8, 218u8, 152u8, 152u8, 44u8,
        ];
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'owner' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                    .as_bytes()
                    .to_vec(),
                tick_lower: substreams::scalar::BigInt::from_signed_bytes_be(log.topics[2usize].as_ref()),
                tick_upper: substreams::scalar::BigInt::from_signed_bytes_be(log.topics[3usize].as_ref()),
                amount: {
                    let mut v = [0 as u8; 32];
                    values
                        .pop()
    ...
    impl Collect {
        const TOPIC_ID: [u8; 32] = [
            112u8, 147u8, 83u8, 56u8, 230u8, 151u8, 117u8, 69u8, 106u8, 133u8, 221u8, 239u8, 34u8, 108u8, 57u8, 95u8,
            182u8, 104u8, 182u8, 63u8, 160u8, 17u8, 95u8, 95u8, 32u8, 97u8, 11u8, 56u8, 142u8, 108u8, 169u8, 192u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl CollectProtocol {
        const TOPIC_ID: [u8; 32] = [
            89u8, 107u8, 87u8, 57u8, 6u8, 33u8, 141u8, 52u8, 17u8, 133u8, 11u8, 38u8, 166u8, 180u8, 55u8, 214u8, 196u8,
            82u8, 47u8, 219u8, 67u8, 210u8, 210u8, 56u8, 98u8, 99u8, 248u8, 109u8, 80u8, 184u8, 177u8, 81u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                sender: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'sender' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                    .as_bytes()
                    .to_vec(),
                recipient: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl Flash {
        const TOPIC_ID: [u8; 32] = [
            189u8, 189u8, 183u8, 29u8, 120u8, 96u8, 55u8, 107u8, 165u8, 43u8, 37u8, 165u8, 2u8, 139u8, 238u8, 162u8,
            53u8, 129u8, 54u8, 74u8, 64u8, 82u8, 47u8, 107u8, 207u8, 184u8, 107u8, 177u8, 242u8, 220u8, 166u8, 51u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
    ...
    impl IncreaseObservationCardinalityNext {
        const TOPIC_ID: [u8; 32] = [
            172u8, 73u8, 229u8, 24u8, 249u8, 10u8, 53u8, 143u8, 101u8, 46u8, 68u8, 0u8, 22u8, 79u8, 5u8, 165u8, 216u8,
            247u8, 227u8, 94u8, 119u8, 71u8, 39u8, 155u8, 195u8, 169u8, 61u8, 191u8, 88u8, 78u8, 18u8, 90u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
    ...
    impl Initialize {
        const TOPIC_ID: [u8; 32] = [
            152u8, 99u8, 96u8, 54u8, 203u8, 102u8, 169u8, 193u8, 154u8, 55u8, 67u8, 94u8, 252u8, 30u8, 144u8, 20u8,
            33u8, 144u8, 33u8, 78u8, 138u8, 190u8, 184u8, 33u8, 189u8, 186u8, 63u8, 41u8, 144u8, 221u8, 76u8, 149u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Mint {
        const TOPIC_ID: [u8; 32] = [
            122u8, 83u8, 8u8, 11u8, 164u8, 20u8, 21u8, 139u8, 231u8, 236u8, 105u8, 185u8, 135u8, 181u8, 251u8, 125u8,
            7u8, 222u8, 225u8, 1u8, 254u8, 133u8, 72u8, 143u8, 8u8, 83u8, 174u8, 22u8, 35u8, 157u8, 11u8, 222u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 4usize {
                return false;
    ...
    impl SetFeeProtocol {
        const TOPIC_ID: [u8; 32] = [
            151u8, 61u8, 141u8, 146u8, 187u8, 41u8, 159u8, 74u8, 246u8, 206u8, 73u8, 181u8, 42u8, 138u8, 219u8, 133u8,
            174u8, 70u8, 185u8, 242u8, 20u8, 196u8, 196u8, 252u8, 6u8, 172u8, 119u8, 64u8, 18u8, 55u8, 177u8, 51u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 1usize {
                return false;
    ...
    impl Swap {
        const TOPIC_ID: [u8; 32] = [
            196u8, 32u8, 121u8, 249u8, 74u8, 99u8, 80u8, 215u8, 230u8, 35u8, 95u8, 41u8, 23u8, 73u8, 36u8, 249u8, 40u8,
            204u8, 42u8, 200u8, 24u8, 235u8, 100u8, 254u8, 216u8, 0u8, 78u8, 17u8, 95u8, 188u8, 202u8, 103u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
