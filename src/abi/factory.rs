...
pub mod functions {
    ...
    impl EnableFeeAmount {
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(&[ethabi::Token::Uint(self.fee), {
                let non_full_signed_bytes = self.tick_spacing.get_big_int().to_signed_bytes_be();
    ...
    impl FeeAmountEnabled {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                ...
                .into_uint()
                .expect(INTERNAL_ERR),
                tick_spacing: EthBigInt::new(substreams::scalar::BigInt::from_signed_bytes_be(
