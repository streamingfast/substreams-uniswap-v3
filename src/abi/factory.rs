...
pub mod functions {
    ...
    impl FeeAmountTickSpacing {
        ...
        pub fn decode(call: &substreams_ethereum::pb::eth::v2::Call) -> Result<Self, String> {
            ...
            let mut values = ethabi::decode(&[ethabi::ParamType::Uint(24usize)], maybe_data.unwrap())
                .map_err(|e| format!("unable to decode call.input: {:?}", e))?;
            values.reverse();
            Ok(Self {
                fee: {
...
pub mod events {
    ...
    impl FeeAmountEnabled {
        const TOPIC_ID: [u8; 32] = [
            198u8, 106u8, 63u8, 223u8, 7u8, 35u8, 44u8, 221u8, 24u8, 95u8, 235u8, 204u8, 101u8, 121u8, 212u8, 8u8,
            194u8, 65u8, 180u8, 122u8, 226u8, 249u8, 144u8, 125u8, 132u8, 190u8, 101u8, 81u8, 65u8, 238u8, 174u8,
            204u8,
        ];
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                fee: {
                    let mut v = [0 as u8; 32];
                    ethabi::decode(&[ethabi::ParamType::Uint(24usize)], log.topics[1usize].as_ref())
                        .map_err(|e| format!("unable to decode param 'fee' from topic of type 'uint24': {:?}", e))?
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_uint()
                        .expect(INTERNAL_ERR)
                ...
                tick_spacing: substreams::scalar::BigInt::from_signed_bytes_be(log.topics[2usize].as_ref()),
            })
        }
    }
    ...
    impl OwnerChanged {
        const TOPIC_ID: [u8; 32] = [
            181u8, 50u8, 7u8, 59u8, 56u8, 200u8, 49u8, 69u8, 227u8, 229u8, 19u8, 83u8, 119u8, 160u8, 139u8, 249u8,
            170u8, 181u8, 91u8, 192u8, 253u8, 124u8, 17u8, 121u8, 205u8, 79u8, 185u8, 149u8, 210u8, 165u8, 21u8, 156u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
            if log.topics.len() != 3usize {
                return false;
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            Ok(Self {
                old_owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| {
                        format!(
                    ...
                    .as_bytes()
                    .to_vec(),
                new_owner: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| {
                        format!(
    ...
    impl PoolCreated {
        const TOPIC_ID: [u8; 32] = [
            120u8, 60u8, 202u8, 28u8, 4u8, 18u8, 221u8, 13u8, 105u8, 94u8, 120u8, 69u8, 104u8, 201u8, 109u8, 162u8,
            233u8, 194u8, 47u8, 249u8, 137u8, 53u8, 122u8, 46u8, 139u8, 29u8, 155u8, 43u8, 78u8, 107u8, 113u8, 24u8,
        ];
        pub fn match_log(log: &substreams_ethereum::pb::eth::v2::Log) -> bool {
        ...
        pub fn decode(log: &substreams_ethereum::pb::eth::v2::Log) -> Result<Self, String> {
            ...
            Ok(Self {
                token0: ethabi::decode(&[ethabi::ParamType::Address], log.topics[1usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'token0' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                ...
                token1: ethabi::decode(&[ethabi::ParamType::Address], log.topics[2usize].as_ref())
                    .map_err(|e| format!("unable to decode param 'token1' from topic of type 'address': {:?}", e))?
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_address()
                    .expect(INTERNAL_ERR)
                ...
                fee: {
                    let mut v = [0 as u8; 32];
                    ethabi::decode(&[ethabi::ParamType::Uint(24usize)], log.topics[3usize].as_ref())
                        .map_err(|e| format!("unable to decode param 'fee' from topic of type 'uint24': {:?}", e))?
                        .pop()
                        .expect(INTERNAL_ERR)
                        .into_uint()
